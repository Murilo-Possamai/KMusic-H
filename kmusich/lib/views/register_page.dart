      ...
      try {
        ...
        switch (e.code) {
          ...
          case 'email-already-exists':
            ...
            break;
          case 'invalid-email':
            NotificationSnack.show(context, "Insira um e-mail valido.");
            break;
          case 'weak-password':
            NotificationSnack.show(context, "Insira uma senha mais forte.");
            break;
          case 'admin-restricted-operation':
            NotificationSnack.show(context, "No momento não foi possível criar sua conta, tente novamente mais tarde! (Code: 403)");
          default:
            NotificationSnack.show(context, e.code);
        }
      }
    } else {
